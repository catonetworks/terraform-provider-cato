		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resRule, "applications.0.%", "2"),
					resource.TestCheckResourceAttrSet(resRule, "applications.0.id"),
					resource.TestCheckResourceAttr(resRule, "applications.0.name", "private-app-1"),
					resource.TestCheckResourceAttr(resRule, "connection_origins.#", "2"),
					resource.TestCheckResourceAttr(resRule, "connection_origins.0", "REMOTE"),
					resource.TestCheckResourceAttr(resRule, "connection_origins.1", "SITE"),
					resource.TestCheckResourceAttr(resRule, "countries.#", "1"),
					resource.TestCheckResourceAttr(resRule, "countries.0.%", "2"),
					resource.TestCheckResourceAttrSet(resRule, "countries.0.id"),
					resource.TestCheckResourceAttr(resRule, "countries.0.name", "United States"),
					...
					resource.TestCheckResourceAttr(resRule, "name", "rule_1"),
					resource.TestCheckResourceAttr(resRule, "platforms.#", "2"),
					resource.TestCheckResourceAttr(resRule, "platforms.0", "LINUX"),
					resource.TestCheckResourceAttr(resRule, "platforms.1", "WINDOWS"),
					...
					resource.TestCheckResourceAttr(resRule, "schedule.custom_recurring.days.0", "MONDAY"),
					resource.TestCheckResourceAttr(resRule, "schedule.custom_recurring.days.1", "FRIDAY"),
					...
					resource.TestCheckResourceAttr(resRule, "source.user_groups.0.name", "group-1"),
					resource.TestCheckResourceAttr(resRule, "source.users.#", "2"),
					resource.TestCheckResourceAttr(resRule, "source.users.0.%", "2"),
					resource.TestCheckResourceAttrSet(resRule, "source.users.0.id"),
					resource.TestCheckResourceAttr(resRule, "source.users.0.name", "test user_1"),
					resource.TestCheckResourceAttr(resRule, "source.users.1.%", "2"),
					resource.TestCheckResourceAttrSet(resRule, "source.users.1.id"),
					resource.TestCheckResourceAttr(resRule, "source.users.1.name", "test user_2"),
					...
					resource.TestCheckResourceAttr(resRule, "tracking.alert.mailing_list.0.name", "mailing_list"),
					...
					resource.TestCheckResourceAttr(resRule, "tracking.alert.subscription_group.0.name", "subscription_group"),
					...
					resource.TestCheckResourceAttr(resRule, "tracking.alert.webhook.0.name", "webhook_1"),
