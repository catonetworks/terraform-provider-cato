...
// hydrateIfwApiRule takes in the current state/plan along with context and returns the created
// diagnostic data as well as cato api data used to either create or update IFW entries
func hydrateWanApiRule(ctx context.Context, plan WanFirewallRule) (hydrateWanApiTypes, diag.Diagnostics) {
	...
	// 					var itemDestinationApplicationInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_Application
	// 					for _, item := range elementsDestinationApplicationInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationApplicationInput, basetypes.ObjectAsOptions{})...)
	...
	// 					var itemDestinationCustomAppInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_CustomApp
	// 					for _, item := range elementsDestinationCustomAppInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationCustomAppInput, basetypes.ObjectAsOptions{})...)
	...
	// 					var itemDestinationAppCategoryInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_AppCategory
	// 					for _, item := range elementsDestinationAppCategoryInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationAppCategoryInput, basetypes.ObjectAsOptions{})...)
	...
	// 					var itemDestinationCustomCategoryInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_CustomCategory
	// 					for _, item := range elementsDestinationCustomCategoryInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationCustomCategoryInput, basetypes.ObjectAsOptions{})...)
	...
	// 					var itemDestinationSanctionedAppsCategoryInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_SanctionedAppsCategory
	// 					for _, item := range elementsDestinationSanctionedAppsCategoryInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationSanctionedAppsCategoryInput, basetypes.ObjectAsOptions{})...)
	...
	// 					var itemDestinationCountryInput Policy_Policy_WanFirewall_Policy_Rules_Rule_Destination_Country
	// 					for _, item := range elementsDestinationCountryInput {
	// 						diags = append(diags, item.As(ctx, &itemDestinationCountryInput, basetypes.ObjectAsOptions{})...)
	...
	// 	rootAddRule.Direction = cato_models.WanFirewallActionEnum(ruleInput.Direction.ValueString())
	// 	rootUpdateRule.Direction = (*cato_models.WanFirewallActionEnum)(ruleInput.Direction.ValueStringPointer())
