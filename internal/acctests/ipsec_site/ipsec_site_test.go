		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(res, "ipsec.primary.tunnels.0.private_cato_ip", "192.168.254.10"),
					resource.TestCheckResourceAttr(res, "ipsec.primary.tunnels.0.private_site_ip", "192.168.254.20"),
					...
					resource.TestCheckResourceAttr(res, "native_network_range", "192.168.254.0/24"),
